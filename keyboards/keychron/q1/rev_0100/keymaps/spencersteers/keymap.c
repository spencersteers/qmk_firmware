...
[MAC_FN] = LAYOUT_ansi_82(
     ...
     RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,   RGB_SPI,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,            _______,
...
[MAC_FN2] = LAYOUT_ansi_82(
     ...
     _______,  _______,  KC_MS_U,  RGB_HUI,  RGB_SAI,  RGB_SPI,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,            KC_PGDN,
     _______,  KC_MS_L,  KC_MS_D,  KC_MS_R,  RGB_SAD,  RGB_SPD,  _______,  _______,  _______,  _______,  _______,  _______,              KC_BTN1,            _______,
